            ...
            for data_payment in payment_table:
                if payment_ref not in payment_object:
                    payment_object[payment_ref] = {
                        ...
                        'date': date_reformat,
                        'payment_date': [data_payment.date],
                    ...
                    payment_object[payment_ref]['payment_date'].append(data_payment.date)
            ...
            for doc in docs:
                ...
                for line in doc.line_ids:
                    ...
                    if code not in journal_items[doc.id]:
                        ...
                        # Check if there are more than 5 items for the product_name and not journal entry type
                        if docs.type != 'entry':
